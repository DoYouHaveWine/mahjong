<template>
	<view class="easy-select" @click.stop="trigger" :style="[easySelectSize]">
		<input style="font-size: 24rpx;" type="text" v-model="value" :placeholder="placeholder" disabled clearable />
		<view class="easy-select-suffix" :style="{ border: '1px solid rgba（0,0,0,0)' }" :class="[showSuffix]"><view class="easy-select-down-tag">^</view></view>
