<!-- mySelect是通过uview1.x的u-select改造的 -->
<template>
	<view class="u-select">
		<u-popup
		...
		>
			<view class="u-select">
				...
				<view class="u-select__body">
					<picker-view @change="columnChange" class="u-select__body__picker-view" :value="defaultSelector" @pickstart="pickstart" @pickend="pickend" v-if="show">
 ...
 * @property {Boolean} show 布尔值变量，用于控制选择器的弹出与收起
 ...
 * @example <u-select :show="show" :list="list"></u-select>
 */
